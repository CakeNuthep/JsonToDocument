...
namespace Xamasoft.JsonClassGenerator
{
    public class JsonClassGenerator : IJsonClassGeneratorConfig
    {
        ...
        public List<DataSet> getDataSetAfterProcess()
        {
        ...
        private DataSet GetDataSetFromJson(IEnumerable<JsonType> types)
        {
            ...
            foreach (var type in types)
            {
                ...
                //CodeWriter.WriteClass(this, sw, type);
                //listString.AddRange(CodeWriter.GetClass(this, sw, type));
                ds.Tables.Add(CodeWriter.GetDataTable(this, type));
            }
            //if (UseNamespaces && inNamespace)
            //{
            //    //CodeWriter.WriteNamespaceEnd(this, sw, rootNamespace);
